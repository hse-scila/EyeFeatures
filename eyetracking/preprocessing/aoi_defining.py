...
def threshold_based(
    data: pd.DataFrame, x: str, y: str, W: int, threshold: float, pk: List[str] = None
):
    ...
    for index, row in result.iterrows():
        ...
        if f"aoi_{min_dist_aoi}" in aoi:
            ...
            centers[f"aoi_{min_dist_aoi}"][0] = centers[f"aoi_{min_dist_aoi}"][0] * (
                len(aoi[f"aoi_{min_dist_aoi}"]) - 1
            ) / len(aoi[f"aoi_{min_dist_aoi}"]) + aoi[f"aoi_{min_dist_aoi}"][-1][
                0
            ] / len(
                aoi[f"aoi_{min_dist_aoi}"]
            )
            centers[f"aoi_{min_dist_aoi}"][1] = centers[f"aoi_{min_dist_aoi}"][1] * (
                len(aoi[f"aoi_{min_dist_aoi}"]) - 1
            ) / len(aoi[f"aoi_{min_dist_aoi}"]) + aoi[f"aoi_{min_dist_aoi}"][-1][
                1
            ] / len(
